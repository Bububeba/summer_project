...
"""
    ...
    weapon = Weapon(Main_Hero.rect.centerx + 33, Main_Hero.rect.centery - 10, 'sprites\scythe3.png', "Main_Hero", 300,
                    200)

    save = Save(Main_Hero, level_num, room_num)
    if is_load:
        Main_Hero.x, Main_Hero.y, Main_Hero.coins_score, Main_Hero.hp, level_num, room_num = save.get_data()
    ...
    while True:
        ...
        if enemy_count > 0 and current_time >= spawn_time:
            ...
            Enemy(
                ...
                randint(HEIGHT // 2 - rooms[room_num].room_h // 2 + 100,
                        HEIGHT // 2 + rooms[room_num].room_h // 2 - 50),
                'sprites\enemy_1.png', hp, damage, speed, 1, enemys, rooms[room_num])
            enemy_count -= 1
            spawn_time += 5
        ...
        if rooms[room_num].is_clear:
            ...
            if rooms[room_num].portal1_x != -1:
                ...
                if rooms[room_num].rect1.collidepoint(*Main_Hero.rect.center):
                    print(rooms[room_num].rect1.center)
